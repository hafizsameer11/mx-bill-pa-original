          ...
          return GetMaterialApp(
            ...
            getPages: [
              ...
              GetPage(
                  ...
                  transition: Transition.rightToLeftWithFade),
              GetPage(
                  name: FundRequestScreen.routeName,
                  page: () => const FundRequestScreen(),
                  transition: Transition.rightToLeftWithFade),
              GetPage(
                  name: AddFundScreen.routeName,
                  page: () => const AddFundScreen(),
                  transition: Transition.rightToLeftWithFade),
              GetPage(
                  name: FundCardPaymentScreen.routeName,
                  page: () => const FundCardPaymentScreen(),
                  transition: Transition.rightToLeftWithFade),
            ],

            ...
            return WillPopScope(
              ...
              child: Scaffold(
                backgroundColor: switchValue
                    ? CustomColors.bodyColorDark
                    : CustomColors.bodyColor,
                body: Stack(
                  children: [
                    Positioned(
                      child: Stack(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: ListTile(
                                            onTap: () {
                                              Get.toNamed(SupportTicketScreen
                                                  .routeName);
                                            },
                                            contentPadding:
                                                EdgeInsets.symmetric(
...
class DeleteAccountListtile extends StatelessWidget {
  ...
  const DeleteAccountListtile({super.key, required this.switchValue});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: Colors.transparent, width: 0.w),
        ),
      ),
      child: ListTile(
        onTap: () {
              ...
              content: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _dialogButton(context, "No", CustomColors.secondaryColor),
                      _dialogButton(context, "Yes", CustomColors.primaryColor,
        ...
        leading: Icon(Icons.person_remove, color: CustomColors.textColorDark),
        title: Text(
          languageController.getStoredData()["Delete Account"] ??
              "Delete Account",
          style: GoogleFonts.jost(
            color: CustomColors.textColorDark,
            fontSize: 16.sp,
  ...
  Widget _dialogButton(BuildContext context, String text, Color color,
      {VoidCallback? onTap}) {
    final languageController = Get.find<LanguageController>();
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          languageController.getStoredData()[text] ?? text,

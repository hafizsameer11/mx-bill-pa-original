import 'package:bill_payment/controller/fund_request_controller.dart';
...
class FundRequestScreen extends StatefulWidget {
  static const String routeName = "/fundRequestScreen";
  const FundRequestScreen({super.key});

  @override
  State<FundRequestScreen> createState() => FundRequestScreenState();
}

class FundRequestScreenState extends State<FundRequestScreen> {
  final controller = Get.put(FundRequestController());
  // language
  ...
  void dispose() {
    ...
    Get.delete<FundRequestController>();
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FundRequestController>(builder: (controller) {
      return WillPopScope(
        onWillPop: () async {
                      ...
                      child: Column(
                        children: [
                                  ...
                                  ? controller.isError
                                      ...
                                      : ListView.builder(
                                          ...
                                          itemCount: controller
                                              .billRequestLists.length,
                                          itemBuilder: (context, index) {
                                            final item = controller
                                                .billRequestLists[index];
                                                        ...
                                                        child: ListView(
                                                          ...
                                                          children: [
                                                            RichText(
                                                              text: TextSpan(
                                                                text:
                                                                    "${languageData["Trx Number"] ?? "Trx Number"}: ${item.trxNumber.toString()}",
                                                                style:
                                                                    GoogleFonts
                                                                        .jost(
                                                                  color: CustomColors
                                                            ...
                                                            RichText(
                                                              text: TextSpan(
                                                                text:
                                                                    "${languageData["Payable"] ?? "Payable"}: ${item.payable.toString()} ${item.payableCurrency.toString()}",
                                                                style:
                                                                    GoogleFonts
                                                                        .jost(
                                                                  color: CustomColors
                                                            ...
                                                            RichText(
                                                              text: TextSpan(
                                                                text:
                                                                    "${languageData["Charge"] ?? "Charge"}: ${item.charge.toString()} ${item.currency.toString()}",
                                                                style:
                                                                    GoogleFonts
                                                                        .jost(
                                                                  color: CustomColors
                                                                    ...
                                                                    children: [
                                                                      RichText(
                                                                        text:
                                                                            TextSpan(
                                                                          text:
                                                                              "Rejected Cause: ${item.rejectedCause != null ? item.rejectedCause.toString() : ""}",
                                                                          style:
                                                                              GoogleFonts.jost(
                                                                            color:
                                                            ...
                                                            //         child: RichText(
                                                            //           text: TextSpan(
                                                            //             text: '${info.fieldName}: ${info.fieldValue}',
                                                            //             style: GoogleFonts.jost(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      crossAxisAlignment:
                                                                          CrossAxisAlignment
                                                                              .start,
                                                                      children: [
                                                                        info.fieldValue.endsWith('.png') ||
                                                                                info.fieldValue.endsWith('.jpg')
                                                                            ? RichText(
                                                                                text: TextSpan(
                                                                                  text: "${info.fieldName}: ",
                                                                                  style: GoogleFonts.jost(
                                                                        ...
                                                                        info.fieldValue.endsWith('.png') ||
                                                                                info.fieldValue.endsWith('.jpg')
                                                                            ? SizedBox(width: 100, child: Image.network(info.fieldValue))
                                                                            : RichText(
                                                                                text: TextSpan(
                                                                                  text: '${info.fieldName}: ${info.fieldValue}',
                                                                                  style: GoogleFonts.jost(
                          ...
                          if (controller.currentPage < controller.lastPage)
                            Container(
                              height:
                                  100, // Customize the loading indicator's height

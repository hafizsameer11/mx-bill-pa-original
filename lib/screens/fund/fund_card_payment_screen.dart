...
class FundCardPaymentScreen extends StatefulWidget {
  static const String routeName = "/fundcardPaymentScreen";
  const FundCardPaymentScreen({super.key});

  @override
  State<FundCardPaymentScreen> createState() => _FundCardPaymentScreenState();
}

class _FundCardPaymentScreenState extends State<FundCardPaymentScreen> {

                ...
                child: SingleChildScrollView(
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          languageData["Create an Account"] ??
                              "Create an Account",
                          style: TextStyle(
                        ...
                        SizedBox(height: 8.h),
                        Text(
                          languageData["Hello there! Sign up to continue."] ??
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return languageData['Please enter your name'] ??
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: InternationalPhoneNumberInput(
                                ...
                                errorMessage:
                                    languageData["Invalid phone number"] ??
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return languageData['Please enter your email'] ??
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value != _passwordController.text) {
                              return languageData['Passwords do not match'] ??
                          ...
                          decoration: InputDecoration(
                            hintText: languageData["Confirm Password"] ??
                                "Confirm Password",
                            hintStyle: TextStyle(
                              color: CustomColors.getTextColor(),
                            ),
                        ...
                        TextButton(
                          ...
                          child: Text(
                            languageData["Already have an account? Sign In"] ??

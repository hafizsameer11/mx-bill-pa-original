  ...
  void onSearchTextChanged(String text) {
    setState(() {
      ...
      if (controller.paymentPreview != null) {
        controller.filteredGateways =
            controller.paymentPreview!.gateways.where((gateway) {
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(controller.capitalizeEachWord(
                                              controller
                                                  .paymentPreview!.category
                                                  .toLowerCase())),
                                        ],
                                      ),
                                      SizedBox(height: 10.h),

...
class KycController extends GetxController {
  ...
  Future<void> fetchKYCData() async {
    ...
    try {
      String apiUrl =
          '${AppConstants.baseUri}${AppConstants.identityVerificationUri}';
      ...
      if (response.statusCode == 200) {
        ...
        textControllers = {
          for (var key in kycData.keys) key: TextEditingController()
        };
        errorMessage = '';
        update();
  ...
  Future<void> submitKYC() async {
    ...
    try {
      String apiUrl =
          '${AppConstants.baseUri}${AppConstants.identityVerificationSubmissionUri}';

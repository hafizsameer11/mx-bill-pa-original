...
class CustomColors {
  ...
  static Color getContainerColor() {
    ...
    return Get.isDarkMode ? containerColorDark : navyBlue;
  }

  static Color getShimmerColor() {
    return Get.isDarkMode ? bodyColorDark : bodyColorDark;
  }
  ...
  static Color getTitleColor() {
    return Get.isDarkMode ? titleColorDark : titleColorDark;
    // return Get.isDarkMode ? titleColorDark : titleColor;
  }

  static Color getTextColor() {
    return Get.isDarkMode ? textColorDark : textColorDark;
    // return Get.isDarkMode ? textColorDark : textColor;
  }

  static Color getInputColor() {
    return Get.isDarkMode ? inputColorDark : inputColorDark;
  ...
  static const Color navyBlue = Color(0xFF130534);

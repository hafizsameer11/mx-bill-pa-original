class AppConstants {
  static String appName = 'MX Bill Pay';

  static const String token = '';
  static String baseCurrency = 'NGN';

  // Base URL
  static const String baseUri = 'https://app.mxbillpay.com';
  ...
  static const String deleteaccountUri = '/api/profile/delete';
  ...
  static const String fundRequestUri = '/api/fund-request';
